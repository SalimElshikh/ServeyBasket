...
namespace DataLayer.Persistence.Migrations
{
    ...
    [Migration("20250318155010_AddVotetAndVoteAnswerTAble")]
    partial class AddVotetAndVoteAnswerTAble
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DataLayer.Entities.VoteAnswer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DataLayer.Entities.Answer", b =>
                {
                    b.HasOne("DataLayer.Entities.ApplicationUser", "CreatedBy")
                        .WithMany()
                    ...
                    b.HasOne("DataLayer.Entities.ApplicationUser", "UpdatedBy")
                        .WithMany()
            ...
            modelBuilder.Entity("DataLayer.Entities.Question", b =>
                {
                    ...
                    b.HasOne("DataLayer.Entities.Poll", "Poll")
                        .WithMany("Questions")
            ...
            modelBuilder.Entity("DataLayer.Entities.VoteAnswer", b =>
                {
                    b.HasOne("DataLayer.Entities.Answer", "Answer")
                        .WithMany()
                    ...
                    b.HasOne("DataLayer.Entities.Vote", "Vote")
                        .WithMany("Answers")
            ...
            modelBuilder.Entity("DataLayer.Entities.ApplicationUser", b =>
                {
                    b.OwnsMany("DataLayer.Entities.RefreshToken", "RefreshTokens", b1 =>
                        {
